...
# Update blacklist-ip
curl -sS https://raw.githubusercontent.com/leesuncom/NetGearR7000/refs/heads/main/common/etc/smartdns/blacklist-ip.conf > /etc/smartdns/blacklist-ip.conf
...
curl -sS https://raw.githubusercontent.com/leesuncom/NetGearR7000/main/common/etc/smartdns/domain-set/domains.china.smartdns.conf -o /tmp/domains.china.smartdns.conf
cp /tmp/domains.china.smartdns.conf /etc/smartdns/domain-set/domains.china.smartdns.conf

# Update GFW List
curl -sS https://raw.githubusercontent.com/leesuncom/NetGearR7000/main/common/etc/smartdns/domain-set/proxy-domain-list.conf -o /tmp/proxy-domain-list.conf
cp /tmp/proxy-domain-list.conf /etc/smartdns/domain-set/proxy-domain-list.conf

# Update address.conf
# curl -sS https://raw.githubusercontent.com/Cats-Team/AdRules/main/smart-dns.conf -o /tmp/address.conf
